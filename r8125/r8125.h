...
#endif
#if defined(NETIF_F_HW_VLAN_TX) && defined(NETIF_F_HW_VLAN_RX)
...
// Redefine Linux kernel version as 2.6.24
...
static inline bool dev_page_is_reusable(const struct page *page) { return 1; }
#endif
#endif
